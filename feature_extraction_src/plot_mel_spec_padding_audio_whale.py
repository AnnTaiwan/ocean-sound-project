...
2. This code is used for all audio in whale category.
3. All audio in whale category is 10 seconds, so they will be padding to 1 minutes by using their original audio.
'''
...
source_folder = r"D:\ocean_sound_project\original_dataset_with_label_name\Z_split1\whale_add_noise20db_train"
destination_folder = r"D:\ocean_sound_project\mix_dataset_ver2\IMAGES\whale_train_add_noise20db_mel_spec"
