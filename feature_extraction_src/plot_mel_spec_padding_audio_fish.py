...
2. This code is used for all audio in fish category.
3. All audio in fish category is 30 seconds, so they will be padding to 1 minutes by using their original audio.
'''
...
source_folder = r"D:\ocean_sound_project\original_dataset_with_label_name\Z_split1\fish_add_noise20db_train"
destination_folder = r"D:\ocean_sound_project\mix_dataset_ver2\IMAGES\fish_train_add_noise20db_mel_spec"
