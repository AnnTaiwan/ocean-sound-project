...
def training(model):
    # 把結果寫入檔案
    file = open("training_result_model_whale_1/training_detail_whale_1.txt", "w")
    # 紀錄最大驗證集準確率
    max_accuracy = 0
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if(accuracy_valid > max_accuracy):
            ...
            if save_parameters:
                path = 'training_result_model_whale_1/model_whale_1.pth'
    ...
    plt.savefig("training_result_model_whale_1/whale_ROC1_ver1.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig("training_result_model_whale_1/whale_Confusion_matrix1_ver1.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("training_result_model_whale_1/whale_Loss1_ver1.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("training_result_model_whale_1/whale_Accuracy1_ver1.png") 
